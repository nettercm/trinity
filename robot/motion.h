...
#define TURN_IN_PLACE(speed,angle) turn_in_place_manneuver(1,(speed),(angle)); while(turn_in_place_manneuver(0,(speed),(angle))) {task_wait(20);}
#define TURN_IN_PLACE_AND_SCAN(speed,angle,filter) turn_in_place_manneuver(1,(speed),(angle)); scan(1,filter); while(turn_in_place_manneuver(0,(speed),(angle))) {scan(0,filter); task_wait(20);}

#define MOVE(speed,distance)		move_manneuver(1,(speed),(distance)); while(move_manneuver(0,(speed),(distance))) {task_wait(20);}
#define MOVE2(speed,distance,sl,sr)	move_manneuver2(1,(speed),(distance),(sl),(sr)); while(move_manneuver2(0,(speed),(distance),(sl),(sr))) {task_wait(20);}
#define GO(speed)					motor_command(7,2,2,10,10); motor_command(6,1,1,(speed),(speed))

#define HARD_STOP()					motor_command(2,0,0,0,0);task_wait(20);
#define SOFT_STOP()					motor_command(6,5,5,0,0);task_wait(20);
